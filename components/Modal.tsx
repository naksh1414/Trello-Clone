...
import TaskTypeRatioGroup from "./TaskTypeRatioGroup";
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
                  className="text-lg font-medium loading-6 text-gray-900 pb-2"
                >
                  Add a Task
                </Dialog.Title>
                ...
                {/* imported Task Type Selection file [todo, inprogress, done] */}
                <TaskTypeRatioGroup />

                {/* UI and Funcitonality for adding an Image */}
                <div>
                  <button
                    onClick={() => {
                  ...
                  {image && (
                    <Image
                      ...
                      width={200}
                      height={200}
                      className="w-full h-44 object-cover mt-2 filter hover:grayscale transition-all duration-150 cursor-auto"
